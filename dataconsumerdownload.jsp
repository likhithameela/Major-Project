...
<body>
    <%
        ...
        <script>alert('download failed  Decryption key not matched');</script> 
    ...
    <div class="content_resize">
	 ...
	 <%
          HttpSession ses=request.getSession(true);
            ...
            rs = st.executeQuery("select * from request where dataemail='"+uid+"'");
...
<tr>
    ...
    <th style="color: black"><%=rs.getString(10)%></th>
     ...
     <td><a href="dataconsumerdownload1.jsp?skey=<%=rs.getString("skey")%>&email=<%=rs.getString("email")%>&filename=<%=rs.getString("filename")%>">Download</a> </td>          

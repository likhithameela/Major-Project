...
<body>
     <%
        ...
        <script>alert('End_User Register Successfully ');</script>
        <%}
            if (request.getParameter("msg1") != null) {%>
        <script>alert('End_User Login Failed ');</script> 
...
<div class="main">
  ...
  <div class="content">
    ...
    <br><br>
           <form name="f" action="enduseract.jsp" method="post" >  <center>
<table>
...
<br>
	  ...
	  <tr>
              <td><br/>
                  ...
                  <a href="enduserregister.jsp"><font color="#2CADFF" size="4"><u>New User?SignUp</u></font></a>

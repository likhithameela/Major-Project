...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="attribute.jsp"><span>Attribute Authority</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
          <center><h2>Attribute Login</h2>
    <br><br>
            <center> <form name="f" action="attributeact.jsp" method="post" onsubmit="return check()">
<table>

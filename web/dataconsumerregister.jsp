...
<body>
    <%
        ...
        <script>alert('Data_Consumer Login_Successfully');</script>
        <%}
  ...
  <div class="content">
    <div class="content_resize">
     ...
     String facultyname=null;
            ...
            %>   
         <center>
	<h2>Data-Consumer Registration Form</h2>
    <br>
            <center> <form action="dataconsumerregisteract.jsp" method="post" id="" >
					  <table width="421">
                      
					    <tr>
                          <th width="191" height="43"><font color="black">Data-Consumer Name </th>
                        ...
                        <tr>
                          ...
                          <td><input id="email" name="dataemail" class="text"  required=""/></td>
                        </tr>
                          ...
                          <td><select id="s1" name="gen" style="width:170px;" class="text" required="">
                            ...
                            <option>FEMALE</option>
                                 ...
                                 <tr>
                          <th height="43"><font color="black">Select Department</th>
                          <td><select id="s1" name="attribute" style="width:170px;" class="text" required="">
                            <% 
                       while(rs.next())
                       {

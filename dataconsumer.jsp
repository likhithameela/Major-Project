...
<body>
    <%
        ...
        <script>alert('Data_Consumer Registration_Success');</script>
        <%}
            if (request.getParameter("msg1") != null) {%>
        <script>alert('login failed email/password wrong ');</script> 
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          ...
          <li class="active"><a href="dataconsumer.jsp"><span>Data Consumers</span></a></li>
          <li><a href="cloudservers.jsp"><span>Cloud Server</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
         ...
         <center>
	<h2>Data-Consumer Login</h2>
    <br><br>
           <form name="f" action="dataconsumeract.jsp" method="post" >  <center>
<table>
...
<br>
	  ...
	  <tr>
              <td><br/>
                  ...
                  <a href="dataconsumerregister.jsp"><font color="#2CADFF" size="4"><u>New User?SignUp</u></font></a>

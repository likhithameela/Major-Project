            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        else if (fileItem.getFieldName().equals("fd")) {
                            fd = fileItem.getString();
                            System.out.println("File Keyword" + fd);
                        }
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into files (file, keyword, fd, filetype, filename, CDate, owner, size, data, frank, file_key)values(?,?,?,?,?,?,?,?,?,?,?)");
                                ...
                                pstm.setString(7, a);
                                pstm.setLong(8, fileItem.getSize());
                                pstm.setString(9, cipher);
                                pstm.setString(10, "0");
                                pstm.setString(11, skey);
                                /*Cloud Start*/
                                ...
                                if (i == 1) {
                                    response.sendRedirect("fileupload.jsp?msg1=success");
                                } else {

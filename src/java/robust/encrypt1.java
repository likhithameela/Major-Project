            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if(fileItem.getFieldName().equals("attribute")) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into upload (filename, data, data1,description,attribute,skey,email)values(?,?,?,?,?,?,?)");

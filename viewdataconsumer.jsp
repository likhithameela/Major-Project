...
<body>
    <%
            if (request.getParameter("acti") != null) {%>
        <script>alert('Data_Consumer Successfully Activated/Attribute Key Sent to Mail ID !');</script>
        <%}
            if (request.getParameter("deac") != null) {%>
        <script>alert('Data_Consumer Successfully DeActivated ! ');</script> 
  ...
  <div class="header">
    <div class="header_resize">
      ...
      <ul>
          ...
          <li class="active"><a href="viewdataconsumer.jsp"><span>View Data Consumers</span></a></li>
...
<tr>
    ...
    <th style="color: black"><%=rs.getString(7)%></th>              
     <th style="color: black"><%=rs.getString(11)%></th>
         <td><a href="dataconsumeractivate.jsp?dataemail=<%=rs.getString("dataemail")%>&attribute=<%=rs.getString(7)%>">Activate</a> </td>
      <td><a href="dataconsumerdeactivate.jsp?dataemail=<%=rs.getString("dataemail")%>" >DeActivate</a> </td>                     
